...
// канал**: сервер шлёт в топик каждого опубликованного сообщения, а на какие
// топики подписаться решает клиент (сейчас — на все уровни своей цепочки). На
// топики без подписчиков доставка no-op. Уровневая политика целиком на стороне
// клиента — серверу знать уровень канала не нужно.
//
